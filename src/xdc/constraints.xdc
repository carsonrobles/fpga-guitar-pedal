...
set_property PACKAGE_PIN E3 [get_ports FPGA_CLK_100]							
	set_property IOSTANDARD LVCMOS33 [get_ports FPGA_CLK_100]
	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports FPGA_CLK_100]
...
set_property PACKAGE_PIN K5 [get_ports RGB_R[0]]					
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_R[0]]
##Bank = 15, Pin name = IO_L5P_T0_AD9P_15,					Sch name = LED16_G
set_property PACKAGE_PIN F13 [get_ports RGB_R[1]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_R[1]]
##Bank = 35, Pin name = IO_L19N_T3_VREF_35,					Sch name = LED16_B
set_property PACKAGE_PIN F6 [get_ports RGB_R[2]]					
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_R[2]]
##Bank = 34, Pin name = IO_0_34,								Sch name = LED17_R
set_property PACKAGE_PIN K6 [get_ports RGB_L[0]]					
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_L[0]]
##Bank = 35, Pin name = IO_24P_T3_35,						Sch name =  LED17_G
set_property PACKAGE_PIN H6 [get_ports RGB_L[1]]					
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_L[1]]
##Bank = CONFIG, Pin name = IO_L3N_T0_DQS_EMCCLK_14,			Sch name = LED17_B
set_property PACKAGE_PIN L16 [get_ports RGB_L[2]]					
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_L[2]]
...
set_property PACKAGE_PIN C12 [get_ports FPGA_RST_N]				
...
set_property PACKAGE_PIN B13 [get_ports {JA_MCLK_TX}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JA_MCLK_TX}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {JA_LRCK_TX}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JA_LRCK_TX}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports {JA_SCLK_TX}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JA_SCLK_TX}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
set_property PACKAGE_PIN E17 [get_ports {JA_SDO_TX}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JA_SDO_TX}]
##Bank = 15, Pin name = IO_0_15,								Sch name = JA7
set_property PACKAGE_PIN G13 [get_ports {JA_MCLK_RX}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JA_MCLK_RX}]
##Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
set_property PACKAGE_PIN C17 [get_ports {JA_LRCK_RX}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JA_LRCK_RX}]
##Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = JA9
set_property PACKAGE_PIN D18 [get_ports {JA_SCLK_RX}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JA_SCLK_RX}]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = JA10
set_property PACKAGE_PIN E18 [get_ports {JA_SDI_RX}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JA_SDI_RX}]
